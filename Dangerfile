...
has_app_changes = !git.modified_files.grep(/MTG Card Tracker/).empty?
has_test_changes = !git.modified_files.grep(/MTG Card TrackerTests/).empty?
...
is_plist_change = git.modified_files.sort == ["MTG Card Tracker/Info.plist"].sort
